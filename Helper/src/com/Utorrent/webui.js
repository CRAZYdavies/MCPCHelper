...
var utWebUI = {
	...
	loadRSSFilter : function (b) {
		...
		var a = [[-1, L_("DLG_RSSDOWNLOADER_30")]];
	...
	feedListClick : function (f) {
		...
		this.refreshSelectedRSSFeeds();
		if (!isGuest && f.isRightClick()) {
			var c = [[L_("DLG_RSSDOWNLOADER_18"), this.showAddEditRSSFeed.bind(this, -1)]];
			if (d) {
				...
				if (a.length > 0) {
					...
					c = c.concat([[L_(g ? "DLG_RSSDOWNLOADER_20" : "DLG_RSSDOWNLOADER_21"), this.rssUpdate.bind(this, {
										id : a,
										enabled : !g
									}, null)], [L_("DLG_RSSDOWNLOADER_22"), this.rssUpdate.bind(this, {
										id : a,
										update : 1
									}, null)], [L_("DLG_RSSDOWNLOADER_23"), (function (i) {
										DialogManager.popup({
	...
	rssfilterListClick : function (e) {
		...
		if (!isGuest && e.isRightClick()) {
			var b = [[L_("DLG_RSSDOWNLOADER_27"), this.rssfilterUpdate.bind(this, null, (function (f) {
	...
	rssfilterQualityClick : function (f) {
		...
		var c = [[CMENU_CHECK, L_("DLG_RSSDOWNLOADER_29"), d(CONST.RSSITEMQUALITY_ALL)], [CMENU_SEP]];
	...
	statusMenuShow : function (b) {
		var a = [[CMENU_CHILD, L_("MM_FILE"), [[L_("MM_FILE_ADD_TORRENT"), this.showAddTorrent.bind(this)], [L_("MM_FILE_ADD_URL"), this.showAddURL.bind(this)]]], [CMENU_CHILD, L_("MM_OPTIONS"), [[L_("MM_OPTIONS_PREFERENCES"), this.showSettings.bind(this)], [L_("OV_TB_RSSDOWNLDR"), this.showRSSDownloader.bind(this)], [CMENU_SEP], [L_("MM_OPTIONS_SHOW_TOOLBAR"), this.toggleToolbar.bind(this, undefined)], [L_("MM_OPTIONS_SHOW_DETAIL"), this.toggleDetPanel.bind(this, undefined)], [L_("MM_OPTIONS_SHOW_STATUS"), this.toggleStatusBar.bind(this, undefined)], [L_("MM_OPTIONS_SHOW_CATEGORY"), this.toggleCatPanel.bind(this, undefined)], [CMENU_SEP], [L_("MM_OPTIONS_TAB_ICONS"), this.toggleDetPanelIcons.bind(this, undefined)]]], [CMENU_CHILD, L_("MM_HELP"), [[L_("MM_HELP_UT_WEBPAGE"), openURL.pass(["http://www.utorrent.com/", null])], [L_("MM_HELP_UT_FORUMS"), openURL.pass(["http://forum.utorrent.com/", null])], [CMENU_SEP], [L_("MM_HELP_WEBUI_FEEDBACK"), openURL.pass(["http://forum.utorrent.com/viewtopic.php?id=58156", null])], [CMENU_SEP], [L_("MM_HELP_ABOUT_WEBUI"), this.showAbout.bind(this)]]], [CMENU_SEP], [CMENU_CHILD, L_("STM_TORRENTS"), [[L_("STM_TORRENTS_PAUSEALL"), this.pauseAll.bind(this)], [L_("STM_TORRENTS_RESUMEALL"), this.unpauseAll.bind(this)]]]];
	...
	showTrtMenu : function (d, g) {
		...
		var f = [[L_("OV_NEW_LABEL"), this.newLabel.bind(this)]];
		...
		var a = {
			...
			removeand : [CMENU_CHILD, L_("ML_REMOVE_AND"), [[L_("ML_DELETE_TORRENT"), this.remove.bind(this, CONST.TOR_REMOVE_TORRENT)], [L_("ML_DELETE_DATATORRENT"), this.remove.bind(this, CONST.TOR_REMOVE_DATATORRENT)], [L_("ML_DELETE_DATA"), this.remove.bind(this, CONST.TOR_REMOVE_DATA)]]],
	...
	showFileMenu : function (k) {
		...
		var a = [];
		var g = [[L_("MF_DONT"), this.setPriority.pass([b, CONST.FILEPRIORITY_SKIP], this)], [CMENU_SEP], [L_("MF_LOW"), this.setPriority.pass([b, CONST.FILEPRIORITY_LOW], this)], [L_("MF_NORMAL"), this.setPriority.pass([b, CONST.FILEPRIORITY_NORMAL], this)], [L_("MF_HIGH"), this.setPriority.pass([b, CONST.FILEPRIORITY_HIGH], this)]];
		...
		var m = [[CMENU_SEP], [L_("MF_GETFILE"), this.downloadFiles.bind(this, b)]];
		var j = false;
		...
		a = a.concat(m);
		a = a.concat([[CMENU_SEP], [L_("MENU_COPY"), this.flsShowCopy.bind(this)]]);
		ContextMenu.clear();
		ContextMenu.add.apply(ContextMenu, a);
	...
	showGeneralMenu : function (b) {
		...
		var a = [[L_("MENU_COPY"), this.showCopy.bind(this, L_("MENU_COPY"), b.target.get("text"))]];
		ContextMenu.clear();
		ContextMenu.add.apply(ContextMenu, a);
		ContextMenu.show(b.page);
		b.stopPropagation()
	...
	showPeerMenu : function (b) {
		...
		var a = [[L_("MP_RESOLVE_IPS"), this.toggleResolveIP.bind(this)], [CMENU_SEP], [L_("MENU_COPY"), this.prsShowCopy.bind(this)]];
	...
	showCookieMenu : function (d) {
		...
		var c = [];
		var b = [["Delete", this.deleteCookies.bind(this)]];
		c = c.concat(b);
		c = c.concat([[CMENU_SEP], [L_("MENU_COPY"), this.ckMgrShowCopy.bind(this)]]);
		ContextMenu.clear();
		ContextMenu.add.apply(ContextMenu, c);
		ContextMenu.show(d.page)
	},
	...
	showFeedMenu : function (c) {
		...
		var a = [[L_("DLG_RSSDOWNLOADER_24"), (function (d) {
					d.each(function (e) {
						this.addRSSFeedItem(e[0], e[1])
					}, this)
				}).bind(this, b)], [L_("DLG_RSSDOWNLOADER_25"), (function (d) {
					d.each(function (f) {
				...
				}).bind(this, b)], [CMENU_SEP], [L_("DLG_RSSDOWNLOADER_26"), (function (d) {
					d.each(function (f) {
						var e = this.getRSSFeedItem(f[0], f[1]);
						if (e) {
				...
				}).bind(this, b)], [CMENU_SEP], [L_("MENU_COPY"), this.fdShowCopy.bind(this)]];
		ContextMenu.clear();
		ContextMenu.add.apply(ContextMenu, a);
